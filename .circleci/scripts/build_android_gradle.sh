...
_sdkmanager_path=${ANDROID_HOME}/tools/bin/sdkmanager
...
sudo yes | sudo $_sdkmanager_path --update
sudo yes | sudo $_sdkmanager_path --licenses
...
$_sdkmanager_path "platforms;android-28"

$_sdkmanager_path --list
